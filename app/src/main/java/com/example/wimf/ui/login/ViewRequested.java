...
import com.example.wimf.StaRequestLayout;
...
public class ViewRequested extends AppCompatActivity {
...
//        });
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            ViewRequested.this.runOnUiThread(new Runnable() {
                                public void run() {
    ...
    public void processJSON(String myResponse) throws JSONException {
        ...
        for (int i = 0; i < ja.length(); i++) {
            ...
            if((jo.getString("RES_NAME")).equals(GlobalVariable2.myresname) && (jo.getString("RESPONSE")).equals("Not yet replied")) {
                StaRequestLayout cl = new StaRequestLayout(this);
                cl.populate(jo);
                if (i % 2 == 0) {
                ...
                cl.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ViewRequested.this,RequestedOrder.class);
