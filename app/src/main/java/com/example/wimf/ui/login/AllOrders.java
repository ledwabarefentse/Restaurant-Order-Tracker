...
//        });
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()) {
                            ...
                            AllOrders.this.runOnUiThread(new Runnable() {
                                public void run() {
    ...
    public void processJSON(String myResponse) throws JSONException {
        ...
        for (int i = 0; i < ja.length(); i++) {
            ...
            if((jo.getString("RES_NAME")).equals(GlobalVariable2.myresname)) {
                ...
                cl.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(AllOrders.this, StatusActivity.class);
